 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	...
	function obtener_datos(id){
			...
			var regimen_cliente = $("#regimen_cliente"+id).val();
			...
			$("#mod_estado").val(status_cliente);
                        $("#mod_razons").val(razon);
			$("#mod_rfc").val(rfc_cliente);
			$("#mod_cp").val(cp_cliente);
			$("#mod_tentidad_basico").val(tipo_cliente);
			$("#mod_regimen").val(regimen_cliente);
			$("#mod_id").val(id);
