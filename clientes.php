...
function llamar_regimen(cod){
	
			$.ajax({
			type: "POST",
			url: "ajax/obtener_regimen.php",
			data: {seleccion:cod.value},
...
function llamar_regimen_edit(cod){
