  ...
  <body>
	...
	<script type="text/javascript" src="js/facturas.js"></script>
	  ...
	  <script>
		  ...
		  function imprimir_ticket(cliente,idtmp,semanatmp){
			VentanaCentrada('ticket.php?cliente='+cliente+'&nticket='+idtmp+'&nsemana='+semanatmp,'Factura','','800','800','true')
			//  window.open('ticket.php?cliente='+cliente+'&nticket='+idtmp+'&nsemana='+semanatmp);
		  }
