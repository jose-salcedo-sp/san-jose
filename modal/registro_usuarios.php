		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax"></div>
			  ...
			  <div class="form-group">
				<label for="user_empresa" class="col-sm-3 control-label">Empresa</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="user_empresa" name="user_empresa" placeholder="Empresa o nombre del cliente" required>
				</div>
			  </div>	
			  <div class="form-group">
			  ...
			  <div class="form-group">
				             <label for="user_tipo" class="col-sm-3 control-label">Tipo de Usuario</label>
				             <div class="col-sm-8">
