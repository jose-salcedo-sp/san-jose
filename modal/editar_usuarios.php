		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div class="form-group">
			  ...
			  <div class="form-group">
				<label for="empresa2" class="col-sm-3 control-label">Empresa</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="empresa2" name="empresa2" readonly>
				</div>
			  </div>	
			  ...
			  <div class="form-group">
				             <label for="user_tipo2" class="col-sm-3 control-label">Tipo de Usuario</label>
				             <div class="col-sm-8">
				             <select class="form-control" id="user_tipo" name="user_tipo2" required>
