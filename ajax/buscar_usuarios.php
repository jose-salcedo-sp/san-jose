			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
				    ...
				    <input type="hidden" value="<?php echo $user_empresa;?>" id="empresa<?php echo $user_id;?>">
				    ...
				    <input type="hidden" value="<?php echo $user_tipo;?>" id="email<?php echo $user_id;?>">
					<tr>
