			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<input type="hidden" value="<?php echo $row['razon_social'];?>" id="razon<?php echo $id_cliente;?>">
					<input type="hidden" value="<?php echo $row['rfc_cliente'];?>" id="rfc_cliente<?php echo $id_cliente;?>">
					<input type="hidden" value="<?php echo $row['cp_cliente'];?>" id="cp_cliente<?php echo $id_cliente;?>">
					<input type="hidden" value="<?php echo $row['tipo_cliente'];?>" id="tipo_cliente<?php echo $id_cliente;?>">
					<input type="hidden" value="<?php echo $row['regimen_cliente'];?>" id="regimen_cliente<?php echo $id_cliente;?>">
