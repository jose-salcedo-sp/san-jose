			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
				    ...
				    <input type="hidden" value="<?php echo $row['etiqueta'];?>" id="etiqueta_producto<?php echo $id_producto;?>">
				    <input type="hidden" value="<?php echo $row['unidad_producto'];?>" id="unidad_producto<?php echo $id_producto;?>">
					<input type="hidden" value="<?php echo $status_producto;?>" id="estado<?php echo $id_producto;?>">
					<input type="hidden" value="<?php echo $row['clave_sat'];?>" id="clave<?php echo $id_producto;?>">
