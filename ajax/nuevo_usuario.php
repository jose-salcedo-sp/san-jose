    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['firstname'])){
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
			    ...
			    $user_empresa = mysqli_real_escape_string($con,(strip_tags($_POST["user_empresa"],ENT_QUOTES)));
			    ...
			    $user_tipo = mysqli_real_escape_string($con,(strip_tags($_POST["user_tipo"],ENT_QUOTES)));
                ...
                if ($query_check_user == 1) {
                    ...
                    $sql = "INSERT INTO users (firstname, lastname, user_empresa, user_name, user_password_hash, user_email, date_added, user_tipo)
                            VALUES('".$firstname."','".$lastname."','".$user_empresa."','".$user_name."', '" . $user_password_hash . "', '" . $user_email . "','".$date_added."','".$user_tipo."');";
