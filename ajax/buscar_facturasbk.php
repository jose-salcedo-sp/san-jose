			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<td class="text-right">
						...
						<a href="#" class='btn btn-default' title='Imprimir Ticket' onclick="imprimir_ticket('<?php echo $id_cliente;?>','<?php echo $id_factura;?>');"><i class="glyphicon glyphicon-print"></i></a>
