		...
		if (empty($_POST['firstname2'])){
          ...
          )
         {
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
			    ...
			    $user_tipo = mysqli_real_escape_string($con,(strip_tags($_POST["user_tipo2"],ENT_QUOTES)));
				
				$user_id=intval($_POST['mod_id']);
					
               
					// write new user's data into database
                    $sql = "UPDATE users SET firstname='".$firstname."', lastname='".$lastname."', user_name='".$user_name."', user_email='".$user_email."', user_tipo='".$user_tipo."'
