...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo "Abastecedora San José"; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        <tr>
           <td style="width:50%;" class='midnight-blue'>ORDEN DE COMPRA A</td>
        </tr>
		<tr>
           <td style="width:50%;" >
			<?php 
       ...
       <br>
		<table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        <tr>
           <td style="width:35%;" class='midnight-blue'>SOLICITA</td>
...
while ($row=mysqli_fetch_array($sql))
	...
	$unidad_producto=$row['unidad_tmp'];
	...
	?>
        ...
        <tr>
			...
			<td class='<?php echo $clase;?>' style="width: 10%; text-align: left"><?php echo $unidad_producto;?></td>
...
?>
<?php //Enviar correo electrónico
/*
$mail = "Aprobación de orden de compra pendiente";
//Titulo
...
$headers .= "From: Administración Lica Group <kdbv28@hotmail.com >\r\n";
//Enviamos el mensaje a tu_dirección_email 
$bool = mail("kdbv28@hotmail.com",$titulo,$mail,$headers);
if($bool){
    echo "Orden enviada para su aprobación";
}else{
    echo "Orden no enviada para su aprobación";
}*/
?>